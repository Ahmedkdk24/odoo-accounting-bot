...
// src/router.js
async function route(request, env, ctx, handlers) {
...
__name(setTelegramToken, "setTelegramToken");
...
__name(sendPlainText, "sendPlainText");
...
__webpack_require__.d(__webpack_exports__, {
  ...
  TextLayer: /* @__PURE__ */ __name(() => (
    /* reexport */
    TextLayer
  ), "TextLayer"),
  TouchManager: /* @__PURE__ */ __name(() => (
    /* reexport */
    TouchManager
  ), "TouchManager"),
  ...
  static get platform() {
    if (typeof navigator !== "undefined" && typeof navigator?.platform === "string") {
      return shadow(this, "platform", {
        ...
        isFirefox: "Cloudflare-Workers".includes("Firefox")
      });
    }
    return shadow(this, "platform", {
      isMac: false,
...
var AnnotationEditorUIManager = class _AnnotationEditorUIManager {
  ...
  static get _keyboardManager() {
    ...
    const arrowChecker = /* @__PURE__ */ __name((self) => self.#container.contains(document.activeElement) && document.activeElement.tagName !== "BUTTON" && self.hasSomethingToControl(), "arrowChecker");
    ...
    return shadow(this, "_keyboardManager", new KeyboardManager([[["ctrl+a", "mac+meta+a"], proto.selectAll, {
      ...
      checker: /* @__PURE__ */ __name((self, {
        target: el
      }) => !(el instanceof HTMLButtonElement) && self.#container.contains(document.activeElement), "checker")
  ...
  #selectionChange() {
    ...
    if (!this.isShiftKeyDown) {
      ...
      const pointerup = /* @__PURE__ */ __name((e) => {
...
var AnnotationEditor = class _AnnotationEditor {
  ...
  #setUpDragSession(event) {
    ...
    const cancelDrag = /* @__PURE__ */ __name((e) => {
      ac.abort();
    ...
    const pointerUpCallback = /* @__PURE__ */ __name((e) => {
...
var FontLoader = class {
  ...
  get isSyncFontLoadingSupported() {
    ...
    if (isNodeJS) {
      supported = true;
    } else if (typeof navigator !== "undefined" && true && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test("Cloudflare-Workers")) {
      supported = true;
    }
  ...
  getColorN_Pattern(IR) {
    ...
    if (IR[0] === "TilingPattern") {
      ...
      const canvasGraphicsFactory = {
        createCanvasGraphics: /* @__PURE__ */ __name((ctx) => new _CanvasGraphics(ctx, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, {
...
var LoopbackPort = class {
  ...
  addEventListener(name, listener, options = null) {
    ...
    if (options?.signal instanceof AbortSignal) {
      ...
      const onAbort = /* @__PURE__ */ __name(() => this.removeEventListener(name, listener), "onAbort");
...
async function handleInvoice(request, env, ctx) {
  ...
  try {
    ...
    if (/Groq API key rejected|Missing GROQ_API_KEY|401|PERMISSION_DENIED|Unauthorized/i.test(message2)) {
    ...
    } else if (/Groq API unavailable|503|Service Unavailable|UNAVAILABLE|timeout/i.test(message2)) {
      await sendPlainText(chatId, "Invoice processing failed because Groq API is temporarily unavailable. Please try again later.");
    } else if (/Groq API error/i.test(message2)) {
...
function parseAiJson(rawText) {
  ...
  if (text.toLowerCase().includes("error") || text.toLowerCase().includes("code:") || !text.includes("{")) {
...
async function createOdooBill(extractedData, env) {
  ...
  if (authData.error) {
    throw new Error(`Odoo auth failed: ${authData.error.message}`);
  }
  const uid = authData.result.uid;
  const sessionId = authData.result.session_id;
  let partnerIds = await odooCall("res.partner", "search", [[["name", "ilike", extractedData.partner_name]]], { limit: 1 }, url, db, uid, password, sessionId);
  if (!partnerIds.length) {
    partnerIds = [await odooCall("res.partner", "create", [{ name: extractedData.partner_name, supplier_rank: 1 }], {}, url, db, uid, password, sessionId)];
  }
  const productIds = await odooCall("product.product", "search", [[["name", "=", "AI Automated Entry"]]], { limit: 1 }, url, db, uid, password, sessionId);
  ...
  return await odooCall("account.move", "create", [billVals], {}, url, db, uid, password, sessionId);
}
__name(createOdooBill, "createOdooBill");
async function odooCall(model, method, args, kwargs, url, db, uid, password, sessionId) {
...
var index_default = {
  async fetch(request, env, ctx) {
    ...
    const handlers = {
      ...
      handleWebhook: /* @__PURE__ */ __name((request2, ctx2) => handleInvoice(request2, env, ctx2), "handleWebhook"),
      registerWebhook: /* @__PURE__ */ __name((request2, env2, url) => registerWebhook(request2, env2, url), "registerWebhook"),
      unRegisterWebhook: /* @__PURE__ */ __name(() => unRegisterWebhook(), "unRegisterWebhook")
    };
